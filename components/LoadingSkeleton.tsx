...
const MESSAGES = [
  ...
  "the model is judging you lovingly...",
  "decoding your cry for help...",
  "calculating the cost of your next therapy session...",
  "translating 'I'm fine' to the truth...",
  "the model is actually gaslighting itself...",
  "formatting your breakdown as a PDF...",
  "validating your feelings (mostly)...",
  "untangling the emotional spaghetti...",
  "finding the perfect color for this crisis...",
  "checking if this is a canon event...",
